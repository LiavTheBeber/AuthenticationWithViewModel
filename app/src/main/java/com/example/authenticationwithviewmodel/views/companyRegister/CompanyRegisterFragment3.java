...
import com.example.authenticationwithviewmodel.adapters.SlideshowPagerAdapter;
...
public class CompanyRegisterFragment3 extends Fragment implements AuthViewModel.FragmentCallback{
    ...
    private AppCompatButton btnNext,btnBack,btnAddProfilePic,btnAddMorePics;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_company_register3, container, false);
        btnNext = view.findViewById(R.id.btnProceed);
        btnBack = view.findViewById(R.id.btnBack);
        btnAddProfilePic = view.findViewById(R.id.btnAddProfPic);
        btnAddMorePics = view.findViewById(R.id.btnAddMorePics);
        companyProfileImageView = view.findViewById(R.id.company_profile_imageView);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        authViewModel.getSavedCompanyProfileImageUri().observe(getViewLifecycleOwner(), companyProfileImageUri->{
            profilePictureUri = companyProfileImageUri;
            Picasso.get().load(profilePictureUri).into(companyProfileImageView);
        });

        authViewModel.getSavedCompanyExtraImages().observe(getViewLifecycleOwner(),companyExtraImages->{
            if (companyExtraImages !=null){
                imagesUris = companyExtraImages;
        ...
        btnNext.setOnClickListener(v -> {
            authViewModel.saveThirdPageCompanyCredentials(imagesUris,profilePictureUri);
        });


        btnBack.setOnClickListener(v -> {
            replaceFragment(new CompanyRegisterFragment2());
        });
